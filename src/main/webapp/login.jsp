...
<html lang="en" class="app js no-touch no-android chrome no-firefox no-iemobile no-ie no-ie10 no-ie11 no-ios no-ios7 ipad">
	...
	<body style="background-image: url('${pageContext.servletContext.contextPath }/admin_files/9.jpg');margin-top:0px;background-repeat: round;"">
		<div id="loginbox" style="padding-top: 10%;">
			<form id="loginform" name="loginform" class="form-vertical"
				...
				<div class="control-group normal_text">
					<table style="width: 100%">
						<tr>
							...
							<td align="center" style="font-weight: bold; color: gray;">意时管理系统</td>
							<td align="right">
								<img src="${pageContext.servletContext.contextPath }/admin_files/logo_left.png" alt="Logo">
							</td>
						</tr>
				...
				<div class="form-actions" style="text-aline: center">
					<span class="pull-left" style="width: 33%">
						<a href="#" class="flip-link btn btn-danger" id="to-recover">忘记密码？</a>
					</span> 
					<!-- <span class="pull-left" style="width: 33%">
